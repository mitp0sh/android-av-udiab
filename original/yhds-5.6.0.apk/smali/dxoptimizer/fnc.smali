.class final Ldxoptimizer/fnc;
.super Ljava/lang/Object;

# interfaces
.implements Ldxoptimizer/fmy;
...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    iput-boolean v0, p0, Ldxoptimizer/fnc;->c:Z

    iput-object p1, p0, Ldxoptimizer/fnc;->a:Landroid/content/Context;

    iput-object p2, p0, Ldxoptimizer/fnc;->b:Ljava/lang/String;

    iput-boolean p3, p0, Ldxoptimizer/fnc;->c:Z
...
.method private a([Landroid/content/pm/Signature;)Z
    ...
    iget-boolean v2, p0, Ldxoptimizer/fnc;->c:Z
    ...
    invoke-static {v1, v2}, Ldxoptimizer/fnf;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6}, Ldxoptimizer/fnf;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method private b(Ljava/lang/String;)Z
    ...
    iget-boolean v0, p0, Ldxoptimizer/fnc;->c:Z
    ...
    invoke-static {v0, v1}, Ldxoptimizer/fnf;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Ldxoptimizer/fnc;->a:Landroid/content/Context;
    ...
    invoke-direct {p0, v0}, Ldxoptimizer/fnc;->a([Landroid/content/pm/Signature;)Z
...
.method public final a()Z
    ...
    :try_start_0
    iget-object v1, p0, Ldxoptimizer/fnc;->a:Landroid/content/Context;
    ...
    invoke-direct {p0, v1}, Ldxoptimizer/fnc;->a([Landroid/content/pm/Signature;)Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(Ldxoptimizer/fmx;)Z
    .locals 4
    ...
    invoke-direct {p0, v1}, Ldxoptimizer/fnc;->b(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v2}, Ldxoptimizer/fnf;->a(Ljava/lang/String;Ljava/lang/String;)V

    :goto_0
    return v0

    :cond_0
    invoke-virtual {p1}, Ldxoptimizer/fmx;->b()Z
    ...
    invoke-virtual {p1, v0}, Ldxoptimizer/fmx;->a(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Ldxoptimizer/fnc;->b:Ljava/lang/String;
    ...
    invoke-static {v1, v2, v0}, Ldxoptimizer/fmv;->a(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Z
...
.method public final a(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0}, Ldxoptimizer/fnc;->b(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v1}, Ldxoptimizer/fnf;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Ldxoptimizer/fnc;->b:Ljava/lang/String;
    ...
    iget-object v2, p0, Ldxoptimizer/fnc;->a:Landroid/content/Context;
    ...
    iget-object v4, p0, Ldxoptimizer/fnc;->b:Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2, v3}, Ldxoptimizer/fmu;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b()Z
    ...
    invoke-virtual {p0}, Ldxoptimizer/fnc;->c()I
...
.method public final c()I
    ...
    invoke-virtual {p0}, Ldxoptimizer/fnc;->a()Z
    ...
    :cond_0
    new-instance v1, Ldxoptimizer/fms;

    iget-object v2, p0, Ldxoptimizer/fnc;->a:Landroid/content/Context;

    invoke-direct {v1, v2}, Ldxoptimizer/fms;-><init>(Landroid/content/Context;)V

    const-string v2, "_build_info_sdk_int_"

    invoke-virtual {v1, v2, v0}, Ldxoptimizer/fms;->getInt(Ljava/lang/String;I)I
